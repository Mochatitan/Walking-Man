...
public class ClockwiseArmCommand extends Command {
  ...
  public ClockwiseArmCommand(LeftArmSubsystem k_leftArmSubsystem, RightArmSubsystem k_rightArmSubsystem) {
  ...
  public void execute() {
    ...
    leftArmSubsystem.setLeftArm(Constants.MAX_ARM_SPEED_UP);
