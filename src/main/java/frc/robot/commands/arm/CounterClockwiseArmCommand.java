...
public class CounterClockwiseArmCommand extends Command {

  private final LeftArmSubsystem leftArmSubsystem;
  private final RightArmSubsystem rightArmSubsystem;

  /** Creates a new ClockwiseArmCommand. */
  public CounterClockwiseArmCommand(LeftArmSubsystem k_leftArmSubsystem, RightArmSubsystem k_rightArmSubsystem) {
  ...
  public void execute() {
    ...
    leftArmSubsystem.setLeftArm(Constants.MAX_ARM_SPEED_DOWN);
    rightArmSubsystem.setRightArm(Constants.MAX_ARM_SPEED_DOWN);
